...
class TrustWebConfig:
    ...
    def from_env(cls) -> TrustWebConfig:
        return cls(
            ...
            llm_explanation_model=os.getenv("TRUSTWEB_LLM_EXPLANATION_MODEL", "openai/gpt-4o"),
            ...
            propagation_iterations=int(os.getenv("TRUSTWEB_PROPAGATION_ITERATIONS", "10")),
            convergence_threshold=float(os.getenv("TRUSTWEB_CONVERGENCE_THRESHOLD", "0.001")),
